...
namespace PFVR.AI
{
    ...
    public class EnemyBehaviorTranslate : MonoBehaviour
    {
        // Fields to set
        ...
        private void CreateAdditionalDiffusion(float diffusionValue)
        {
            ...
            diffusionVector.x += diffusionValue * randNum;
            randNum = MarsagliaGenerator.Next();
            diffusionVector.y += diffusionValue * randNum;
            randNum = MarsagliaGenerator.Next();
            diffusionVector.z += diffusionValue * randNum;
        }
